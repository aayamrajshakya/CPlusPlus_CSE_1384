...
Description: This C++ program defines a Playlist class with several member functions to manage a list of songs.
            The program is designed to provide basic functionality for managing a playlist of songs, including adding, 
            shuffling, and searching for songs, as well as sorting them by title in either ascending or descending order.
*/
...
{
// perform binary search on the playlist
    int left = 1;
    int right = size;
    while (left <= right)
    {
